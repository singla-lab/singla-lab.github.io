...
ACCENTS = [('indigo', 'Indigo'), ('plum', 'Plum'),
           ('madder', 'Madder'), ('saffron', 'Saffron'), ('slate', 'Slate')]
...
THEME_BOOT = ("<script>(function(){try{var t=localStorage.getItem('theme');"
              ...
              "var a=localStorage.getItem('accent');if(a==='plum'||a==='madder'||a==='slate'||a==='saffron')document.documentElement.dataset.accent=a;}catch(e){}})();</script>")
